...
class FailedInternetConnection extends MapsClusterState {
  FailedInternetConnection();
}

class MapsClusterSelectedDefaultMarker extends MapsClusterState {
  int index;
  MapsClusterSelectedDefaultMarker(this.index);
}
