...
class ParkingIndex extends StatefulWidget {
  const ParkingIndex({Key? key}) : super(key: key);

  @override
  _ParkingIndexState createState() => _ParkingIndexState();
}
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Container(
              ...
              child: Center(
                child: Text(
                  translate('app_bar.parking_report'),
        ...
        body: SafeArea(child: alarmList('parking', '', '',context)),
      ),
    );
  }
    ...
    return BlocListener<AlarmReportBloc, AlarmReportState>(
      ...
      child: BlocBuilder<AlarmReportBloc, AlarmReportState>(
        builder: (context, state) {
          ...
          if (state is AlarmReportError) {
            print('PARKING_ERRORMOREREPORT${state.message}');
            _refreshController
              ..loadFailed()
              ..refreshFailed();
          }
                    ...
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ParkingNotiCard(
                              ...
                              notiTitle: translate('parking_report_page.notification'),
                    ...
                    : Container(
                        child: Center(
                          child: Container(
                            ...
                            child:  Text(
                             translate('parking_report_page.no_report'),
