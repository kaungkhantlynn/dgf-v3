...
class DriverCard extends StatelessWidget {
  ...
  int? id;
   ...
   DriverCard({Key? key,this.date, this.licenseNumber, this.name, this.licenseType,this.status,this.id}) : super(key: key);
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Text( translate('vehicle_management_page.name'),
                        style: TextStyle(
                            color: Colors.grey.shade500,
                            fontFamily: 'Kanit',
                            fontSize: 17,
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                      translate('vehicle_management_page.license_type'),
                        style: TextStyle(
                            color: Colors.grey.shade500,
                            fontFamily: 'Kanit',
                            fontSize: 17,
                      ...
                      Wrap(
                        ...
                        children: [
                          OutlinedButton(
                              ...
                              onPressed: () {
                                Navigator.pushNamed(context, EditDriver.route,
                                    arguments: DriverArguments(id!));
                                // print("EDITBTNCLICK");
                              },
                              child: Icon(
                                Icons.edit,
