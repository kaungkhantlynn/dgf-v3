...
class WsuArguments {
  final int id;
  WsuArguments(this.id);
}

class WsuCard extends StatelessWidget {
  int? id;
  DateTime? date;
  String? name;
  int? vehicleId;
  ...
  DateTime? startDate;
  DateTime? endDate;
  WsuCard({required this.id,required this.date,required this.name,required this.vehicleId,required this.license,
  required this.brand,required this.startDate,required this.endDate});
                      ...
                      Wrap(
                        ...
                        children: [
                          OutlinedButton(
                              ...
                              onPressed: () {
                                Navigator.pushNamed(context, EditWsu.route,
                                    arguments: WsuArguments(id!));
                              },
                              child: Icon(
                                Icons.edit,
                                color: HexColor('#0F8E70'),
