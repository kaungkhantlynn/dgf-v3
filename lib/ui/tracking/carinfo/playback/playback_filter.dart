...
class PlaybackFilter extends StatefulWidget {
  static const String route = '/playback_filter';
  const PlaybackFilter({Key? key}) : super(key: key);

  @override
  _PlaybackFilterState createState() => _PlaybackFilterState();
}
...
class PlaybackArguments {
  ...
  PlaybackArguments({this.license, this.formattedDate});
}

class _PlaybackFilterState extends State<PlaybackFilter> {
  ...
  Widget build(BuildContext context) {
    final args =
        ModalRoute.of(context)!.settings.arguments as PlaybackFilterArguments;
    return Scaffold(
      appBar: AppbarPage(
        title: translate('app_bar.playback'),
      ),
      body: Column(
        children: [
          TableCalendar<Event>(
